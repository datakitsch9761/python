...
local()
print('전역변수 num', num) #10(x) -> 20이라는 전역변수를 사용하고 싶다
...
print(f'전체 방문횟수 : {count}') #전역변수를 출력한다
...
add2(10,10,10)
add2(10,10,10,10,10)
add2(10,10,10,10,10,10,10,10,10)
...
# => 인수값 앞에 매개변수명을 지정
def computeSunjJuk(name,kor,eng,mat):
    tot = kor + eng + mat
    avg = tot / 3
    print(tot,avg)

computeSunjJuk('혜교', 98,78,65)
computeSunjJuk(98,78,65,'수지') #오류발생
computeSunjJuk(98,78,65, name = '수지') #오류발생

computeSunjJuk(kor=98,eng=78,mat=65, name = '수지')
computeSunjJuk(name='지현',kor=78,eng=65,mat=99)
