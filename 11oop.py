...
# def SungJukProgram(): #함수에 너무많은 기능을 부여
#     pass              #하나의 기능만 부여
...
#'차'라고 인지할 만한 특성 정의
class Car :
    def __init__(self, size,color,wheels,doors,isLoad): #생성자 # __init__ -> initialize
        self.size = size
        self.color = color
        self.wheels = wheels
        self.doors = doors
...
sj1 = SungJuk('혜교', 86, 54,74)

print(sj1)


# 사원 관리를 위한 사원 Employee 클래스를 정의하세요
...
class Employee :
    ...
    def __str__(self):
        result = f'{self.empno} {self.lname} {self.fname} {self.empno} {self.phone} {self.hdate}' \
                 f'{self.jobid} {self.sal} {self.comm} {self.mgr} {self.deptid}'
        return result

emp = Employee(123,'Steven','King','king@email.com','1234567','2003-06-17','AD-PRES',24000,'','',90)
print(emp)